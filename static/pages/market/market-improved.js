...
class MarketPage {
  ...
  async loadMarketData(limit = 50) {
    try {
      ...
      if (!Array.isArray(data) || data.length === 0) {
        console.warn('[Market] All APIs failed, using demo data');
      ...
      this.allMarketData = [...this.marketData];
      this.renderMarketTable();
  ...
  getDemoData() {
    return [
      { id: 'bitcoin', name: 'Bitcoin', symbol: 'btc', image: 'https://assets.coingecko.com/coins/images/1/small/bitcoin.png', current_price: 43250, price_change_percentage_24h: 2.5, price_change_percentage_7d_in_currency: 5.2, market_cap: 850000000000, total_volume: 25000000000 },
      { id: 'ethereum', name: 'Ethereum', symbol: 'eth', image: 'https://assets.coingecko.com/coins/images/279/small/ethereum.png', current_price: 2350, price_change_percentage_24h: 3.2, price_change_percentage_7d_in_currency: 7.8, market_cap: 280000000000, total_volume: 12000000000 },
      { id: 'solana', name: 'Solana', symbol: 'sol', image: 'https://assets.coingecko.com/coins/images/4128/small/solana.png', current_price: 105, price_change_percentage_24h: -1.8, price_change_percentage_7d_in_currency: -3.5, market_cap: 45000000000, total_volume: 2500000000 }
    ];
  }
