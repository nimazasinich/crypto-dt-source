/**
 * ============================================
 * SVG ICON LIBRARY - Enterprise Edition
 * Crypto Monitor Ultimate
 * ============================================
 *
 * Unified SVG icon system using Lucide/Heroicons style
 * All icons support:
 * - Color inheritance
 * - Dark/light mode
 * - RTL mirroring
...
class IconLibrary {
    ...
    initializeIcons() {
        return {
            ...
            dollarSign: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>',
            ...
            pieChart: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg>',

            barChart: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="20" x2="12" y2="10"></line><line x1="18" y1="20" x2="18" y2="4"></line><line x1="6" y1="20" x2="6" y2="16"></line></svg>',
            ...
            settings: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M12 1v6m0 6v6m5.2-15.6l-4.2 4.2m-6 6l-4.2 4.2M23 12h-6m-6 0H1m15.6 5.2l-4.2-4.2m-6-6l-4.2-4.2"></path></svg>',
            ...
            ethereum: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L4 12l8 5 8-5-8-10z"></path><path d="M4 12l8 10 8-10-8 5-8-5z"></path></svg>',
    ...
    getIcon(name, size = 24, className = '') {
        ...
        if (!iconSvg) {
            ...
            return this.icons.alertCircle; // Fallback icon
        }
...
// Utility function for easy icon usage
...
console.log('[Icons] Icon library loaded with', window.iconLibrary.getAvailableIcons().length, 'icons');
