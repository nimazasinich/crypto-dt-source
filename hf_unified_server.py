...
app.include_router(crypto_hub_router)  # NEW: Crypto API Hub Dashboard
...
async def crypto_api_hub_page():
    ...
    return FileResponse("static/crypto-api-hub-dashboard.html")
...
async def api_root():
    ...
    return {
        ...
        "endpoints": {
            ...
            "documentation": {"swagger_ui": "/docs", "openapi_spec": "/openapi.json"},
        },
        "models_available": [
            "ElKulako/cryptobert",
            "kk08/CryptoBERT",
